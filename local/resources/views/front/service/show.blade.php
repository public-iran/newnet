...
@section('content')
    ...
    {{--***************************************************** start Product Box *****************************************************--}}
    <div class="row ali-row-back ali-box-style" style="display: flex">
        {{--            <img class="img-fluid"--}}
        {{--                 src="{{asset($service->imgPath)}}"--}}
        {{--                 alt="تصویر نیست">--}}
        ...
        <div class="col-lg-6 " align="center">
            ...
            <div class="slideshow-container">
                ...
                <div class="mySlides fade ali-max">
                    <img class="ali-max" src="https://www.iran-booking.com/uploads/hotels/main/homa-hotel-tehran-main.jpg" style="width:100%">
                </div>

                <div class="mySlides fade ali-max">
                    <img class="ali-max" src="https://cdn.mehrbooking.net/samita/Images/Hotels/shiraz-homa-hotel-facade-1.jpg" style="width:100%">
                </div>

                <div class="mySlides fade ali-max">
                    <img class="ali-max" src="https://www.alaedin.travel/Files/Hotels/shiraz/homa/Alaedin-Travel-Agency-Shiraz-Homa-Hotel-(88).jpg" style="width:100%">
                </div>
            ...
            <div class="col-lg-12">
                <div class="card shadow-16dp ali-padding-15">
                    ...
                    <div class="px-20 pt-20">
                        ...
                        <!--title and subtitle-->
                            <div class="w-70-lg">
                                <div class="h4 line-height-sm font-weight-bold">{{$service->title}}</div>
                            </div>
                    ...
                    <div class="pt-16 pb-20 px-20">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-7 ali-flex">
                                ...
                                <div class="col-lg-8">
{{--                                    <p class="text-muted">{{$service->mainPrice}} ریال</p>--}}
...
{{--                                            <button onclick="addToBasket({{$service->id}})"--}}
...
{{--                    @endif--}}
    ...
    <div class="row ali-row-back ali-box-style" style="display: block">
        ...
        <div class="row ali-flex ali-padding-2040">
            @foreach($newService as $key=>$item)
                @if($key>=5)
                    @break
                @endif
    ...
    <div class="modal ali-modal" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
         aria-hidden="true">
                ...
                <div class="modal-footer">
                    ...
                    @if(auth()->user())
                        <button id="replycm" type="button" class="btn btn-primary"
                                ...
                                onclick="storeComment('{{$service->id}}',{{auth()->id()}})" data-parentid=""
                                data-dismiss="modal">
                            ثبت نظر
                        </button>
                    @endif
