                ...
                <script>
                        ...
                        $('#md_checkbox_30').click(function () {
                            ...
                            if ($(check).is(':checked')) {
                                ...
                                $('#next-setp').click(function () {
                                    $('#prevBtn').remove();
                                    $('.next-level-1').append('<button type="button" id="prevBtn" onclick="nextPrev(-1)" class="btn bg-green waves-effect" style="float: right">مرحله قبل</button>');
                                    $('#next-setp').remove();
                                    $('.check-width').css('background','none');
                                    $('#policy').css('display','none');
                                    $('#md_checkbox_30').removeAttr('checked');
                    ...
                    $('#md_checkbox_5').on('change', function() {
                        ...
                        $('#next-setp').click(function () {
                            $('#next-setp').remove();
                            $('#prevBtn').remove();
                            $('.next-level-1').append('<button type="button" id="prevBtn" onclick="nextPrev(-2)" class="btn bg-green waves-effect" style="float: right">مرحله قبل</button>');
