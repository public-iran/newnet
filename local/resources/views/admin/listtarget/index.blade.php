        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            @if(session('add-listtargets') and session('add-listtargets')=='success')
                <div class="alert alert-success alert-dismissible">
                    ...
                    لیست اهداف با موفقیت     <strong> تائید شد! </strong>{{-- و کاربر به مرحله بعدی ارتقا یافت .--}}
                </div>
            @endif
                @if(session('add-listtargets') and session('add-listtargets')=='Unconfirmed')
                <div class="alert alert-danger alert-dismissible">
                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                    لیست اهداف با موفقیت     <strong> رد شد! </strong>{{-- و کاربر به مرحله بعدی ارتقا یافت .--}}
                </div>
            @endif
...
{{--                    </div>--}}
                ...
                <div class="body">
                    <div class="row clearfix users">
                        <?php $i=0; ?>
                        @foreach($listtargets as $user)
                             @if($user->confirmation!='Unconfirmed')
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 user">
                                <div class="card">

                                    <a href="{{route('listtargets.show',$user->user_id)}}">
                                        <div class="header">
                                            @if($user->confirmation=='NO')
