...
@section('content')
    <div class="row main-index listpeople">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            @endif
            @if(session('add-goldenlist') and session('add-goldenlist')=='success')
                <div class="alert alert-success alert-dismissible">
                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                    لیست افراد با موفقیت     <strong> تائید شد! </strong>{{-- و کاربر به مرحله بعدی ارتقا یافت .--}}
                </div>
            @endif
                @if(session('add-goldenlist') and session('add-goldenlist')=='Unconfirmed')
                        ...
                        @foreach($listpeoples as $user)
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 user">
                                <div class="card">
                                    ...
                                    <a href="{{route('goldenlist.show',$user->id)}}">
                                        <div class="header">
