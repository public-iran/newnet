        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="card">
                <div class="header">
                        ...
                        <a href="{{route('goldenlist.index')}}" style="float:left;margin-top: -10px;" type="button" class="btn btn-default btn-circle waves-effect waves-circle waves-float">
                            <i class="material-icons">reply</i>
                        </a>

                        <h2>لیست ارسال شده توسط:  {{$listpeople->user->name}}</h2>
                ...
                <div class="body">
                    ...
                    @if($listpeople->confirmation=='NO')
                        <form method="post" action="{{route('goldenlist.update',$listpeople->id)}}">
                            @method('PATCH')
                            @csrf
