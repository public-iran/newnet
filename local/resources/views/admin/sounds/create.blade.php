...
@section('content')
    ...
    <div class="row clearfix main-index sounds">
            ...
            <div class="card">
                <div class="header">
                    <h2>
                        ...
                        <a href="{{route('sounds.index')}}" style="float:left;margin-top: -10px;" type="button" class="btn btn-default btn-circle waves-effect waves-circle waves-float">
