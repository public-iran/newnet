...
@section('content')
    <div class="row clearfix main-index users">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            ?>
                {!! Form::model($user, ['method' => 'PATCH', 'action'=> ['Admin\AdminAdminController@update', $user->id], 'files'=>true]) !!}
                ...
                <div class="card">
                    <div class="header">
                        ...
                        <a href="{{route('adminlist.index')}}" style="float:left;margin-top: -30px" type="button" class="btn btn-default btn-circle waves-effect waves-circle waves-float">
