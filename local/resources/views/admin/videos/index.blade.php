        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            @if(session('insert-video') and session('insert-video')=='success')
                <div class="alert bg-green alert-dismissible" role="alert">
                    ...
                    ویدیو شما با موفقیت آپلود شد و بعد از تایید مدیر در سایت نمایش داده می شود.
                </div>
            @endif
            ...
            <div class="card">
                <div class="header" style="margin-bottom: 20px">
                    <a href="{{route('videos.create')}}" type="button" class="btn btn-primary btn-circle waves-effect waves-circle waves-float">
                                    ...
                                    <div id="aniimated-thumbnials" class="list-unstyled row clearfix photo-user">
                                        @foreach($videos as $video)
                                            ...
                                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                <a href="{{asset('images/videos/'.$video->path)}}" data-sub-html="Demo Description">
                                                    <img class="img-responsive thumbnail" src="{{asset('images/videos/'.$video->path)}}">
                                                    <ul>
                                                        <li>استان : {{$video->ostan}}</li>
                                                        <li>شهر : {{$video->city}}</li>
                                                        <li>نوع : {{$video->category}}</li>
                                                        <li>تاریخ بارگزاری : {{Verta::instance($video->create_at)->format('Y/n/j')}}</li>
                                            ...
                                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 photo">
                                                <div class="main">
                                                    ...
                                                    <div class="file-footer-buttons">
                                                        <button onclick="delete_photo('{{$video->id}}','DELETE',this)" type="button" class="kv-file-remove btn btn-sm btn-kv btn-default btn-outline-secondary" title="حذف تصویر"><i class="material-icons">delete_forever</i></button>
                                                    @if($video->status=='UNSEEN')
                                                        <button id="SEEN" onclick="status_photo('{{$video->id}}','SEEN',this)" type="button" class="kv-file-upload btn btn-sm btn-kv btn-default btn-outline-secondary" title="نمایش"><i class="material-icons">visibility</i></button>
                                                        @else
                                                        <button id="UNSEEN" onclick="status_photo('{{$video->id}}','UNSEEN',this)" type="button" class="kv-file-zoom btn btn-sm btn-kv btn-default btn-outline-secondary" title="عدم نمایش"><i class="material-icons">visibility_off</i></button>
                                                        @endif
