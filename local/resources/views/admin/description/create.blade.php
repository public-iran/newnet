                                ...
                                <div id="product">
                                    ...
                                    <div id="levels">
                                        <div class="form-group form-float rules">
                                            ...
                                            <div class="form-line">
                                                <textarea id="textarea1" name="description[]" cols="30" rows="5" placeholder="قوانین خود را وارد کنید..." class="form-control no-resize" required="" aria-required="true"></textarea>
...
@section('script')
    ...
    <script>
        ...
        function add_levels(tag,b) {
            ...
            $('#levels').append('<div class="form-group form-float rules '+i+'"> <button type="button" class="btn bg-pink waves-effect del-rules">حذف</button><div class="form-line">\n' +
                '<textarea id="textarea'+i+'" name="description[]" cols="30" rows="5" class="form-control no-resize" required="" placeholder="قوانین خود را وارد کنید..." aria-required="true"></textarea>\n' +
                '                                                </div>\n' +
                '                                            </div>');
