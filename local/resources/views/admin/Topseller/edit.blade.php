            ...
            <div class="card">
                <div class="header">
                    <h2>
                        ...
                        <a href="{{route('Topseller.index')}}" style="float:left;margin-top: -10px;" type="button" class="btn btn-default btn-circle waves-effect waves-circle waves-float">
                            <i class="material-icons">reply</i>
                        </a>
                    </h2>

                </div>
                {!! Form::open(['method'=>'PATCH','action'=>['Admin\AdminTopsellerController@update',$topseller->id],'files'=>true]) !!}
