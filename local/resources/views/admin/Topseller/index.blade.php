...
@section('content')
    <div class="row main-index Topseller">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="card">
                <div class="header h">
                    ...
                    <a href="{{route('Topseller.create')}}" type="button"
                                        ...
                                        <ul class="header-dropdown m-r--5">
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    <li><a href="{{route('Topseller.edit',@$top_seller->id)}}">ویرایش</a></li>
                                                    <li>
                                                    <form method="post" action="{{route('Topseller.destroy',$top_seller->id)}}">
                                                        @csrf
